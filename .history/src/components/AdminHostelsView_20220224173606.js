...
const HostelListItem = ({ name, images }) => {
  return (
    <div className="group w-full md:w-auto  my-2 bg-white rounded h-12 font-semibold text-gray-800 mr-5 relative  hover:bg-indigo-600 hover:text-white flex space-x-3 justify-center items-center">
