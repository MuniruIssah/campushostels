...
const HostelModalContent = ({
  ...
  return (
    <div className="flex flex-col p-6 ">
      ...
      <span className="font-extrabold text-2xl text-gray-800 mb-3">
        {description}
      </span>
      ...
      {room_types.length > 0 && (
        <div className="flex flex-wrap mb-3">
          {room_types.map((room_type) => (
            <div className="border border-gray-600 text-gray-600 py-1 px-2 mr-2 mb-2 hover:text-white hover:bg-gray-600">
              {room_type} in a room
            </div>
          ))}
        </div>
