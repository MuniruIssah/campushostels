...
const HostelListItem = ({ name, description }) => {
  return (
    <div className="group w-auto mx-2 my-2 bg-white rounded py-4 px-4 text-gray-800 mr-5 relative hover:ring hover:ring-indigo-600 hover:bg-indigo-100 hover:text-indigo-600">
