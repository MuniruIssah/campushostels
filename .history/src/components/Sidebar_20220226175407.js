...
const HostelModalContent = ({
  ...
  return (
    <div className="flex flex-col p-6 ">
      <button className="text-blue-500 bg-blue-100  px-4  md:self-start py-2 rounded rounded-md hover:shadow-md hover:bg-blue-600 hover:font-semibold hover:">
        {contact}
      </button>
      {services?.length > 1 && (
      ...
      <div>
        <span className="">{location.latitude},{location.longitude}</span>
      </div>
      <span className="">
        {gender}
      </span>
