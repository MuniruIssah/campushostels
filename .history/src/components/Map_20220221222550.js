  ...
  return (
    <div className="flex-1 md:basis-3/4 h-full bg-blue-500">
      ...
      >
        {hostels?.map((place, i) => (
          <div
            className="absolute z-[1] hover:z-[2] -translate-x-1/2  "
          ...
          >
            {isMobile ? (
              ...
              <div className="shadow shadow-lg w-24 h-auto bg-white p-2 rounded rounded-md">
                <span className="text-sm mb-2 block text-semibold">{place.name}</span>
                <img
