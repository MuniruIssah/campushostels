...
const Team = () => {
 const members=[
     {
         profileImage:'https://mdbcdn.b-cdn.net/img/new/avatars/8.webp',
         name:'Imaam Mansoor',
    ...
    <div className="bg-gray-900 w-full">
      <div className="flex flex-col items-center justify-center space-y-5 md:space-y-10 lg:p-20 p-10 w-full">
        ...
        <div className=" md:flex md:justify-center md:space-x-20 md:items-start w-full">
            {
                members.map((member,index)=><div class="group text-center mb-5 py-3 px-6 rounded rounder-lg hover:bg-gray-800">
                <img
