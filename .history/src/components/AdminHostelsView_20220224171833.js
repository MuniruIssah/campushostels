...
const HostelListItem = ({ name, description }) => {
  return (
    <div className="w-auto my-2 bg-white rounded py-2 px-4 text-gray-800 mr-5 relative">
      <div className="absolute t-op-0 right-0 ring ring-indigo-700 bg-indigo-100 rounded rounded-full p-1">
