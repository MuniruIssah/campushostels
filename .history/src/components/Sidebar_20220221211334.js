...
const HostelItem = ({
  ...
  return (
    <div className="h-52 flex shadow shadow-2xl bg-white my-3 rounded rounded-lg m-2">
      <img
        src={images[1] ? images[1] : images[0]}
        alt=""
        className="w-full h-32 object-cover hover:contrast-50 rounded rounded-lg m-3"
      />
    </div>
  );
};
