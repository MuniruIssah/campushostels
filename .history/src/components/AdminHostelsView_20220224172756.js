...
const HostelListItem = ({ name, images }) => {
  return (
    <div className="group w-full md:w-auto mx-2 my-2 bg-white rounded py-4 px-4 font-semibold text-gray-800 mr-5 relative  hover:bg-indigo-600 hover:text-white flex-">
