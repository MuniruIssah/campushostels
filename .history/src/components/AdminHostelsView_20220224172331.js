...
const HostelListItem = ({ name, description }) => {
  return (
    <div className="group w-auto mx-2 my-2 bg-white rounded py-4 px-4 font-semibold text-gray-800 mr-5 relative hover:ring hover:ring-indigo-600 hover:bg-indigo-700 hover:text-indigo-600">
      <div className="hidden group-hover:block absolute -top-1 -right-1 ring ring-indigo-600 bg-indigo-100 rounded rounded-full p-1">
