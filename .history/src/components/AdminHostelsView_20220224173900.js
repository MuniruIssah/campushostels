...
const HostelListItem = ({ name, images }) => {
  return (
    <div className="group w-full md:w-auto p-3 my-2 bg-white rounded h-14 font-semibold text-gray-800 mr-5 relative  hover:bg-indigo-600 hover:text-white flex  md:justify-center items-center">
