  ...
  return (
    <div className="w-screen">
      ...
      <nav className="py-3 flex justify-center md:justify-start shadow-md px-5">
        <NavLink to="" className=({ isActive }) => (isActive ? "sidenav__items__item sidenav__items__item--active" : "sidenav__items__item")'py-2 px-4 font-semibold rounded rounded-full hover:bg-indigo-700 hover:text-white'  >Hostels</NavLink>
