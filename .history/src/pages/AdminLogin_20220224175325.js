...
const AdminLogin = () => {
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center p-6 bg-gray-900">
      <form className="w-full md:w-96 shadow-lg h-auto p-7 rounded rounded-lg bg-gray-700" onSubmit={handleSubmit}>
        <div className="mb-6">
        ...
        <button type="submit" className="block w-full px-5 py-3 text-center font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded rounded-lg">
          Login
        </button>
      </form>
    </div>
